// www.kreativekiste.de // 07.04.2026 // Version 2.9
            ...
            page.components.forEach(compData => { 
                if (compData.parentId === parentId && compData.type !== 'hauptkontakt') {
                    ...
                    if (window.numberingMode === 'continuous') {
                        // LOGIK 1: FORTLAUFEND (Wie in V2.6)
                        let position = 1;
                        if (type === 'schliesser') { 
                            if (subtype !== 'normal') { 
                        ...
                        // LOGIK 2: DIN POSITION (Wie in V2.8)
                        if (type === 'schliesser') { 
